...
# Inkscape extension
I attempted to create an inkscape extension for MassInk ([Here is my attempt](./Inkscape)) ... i gave up as inkscape has little to no documentation on extension development and from what i managed to write the inkex python system for custom extensions is not in a state that allows simple extension development ...
